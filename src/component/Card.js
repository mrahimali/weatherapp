...
const Card = () => {
    ...
    useEffect(() => {
        const fetchAPI=async ()=>{
            const url=`https://api.openweathermap.org/data/2.5/weather?q=${search}&units=metric&appid=29c21bace495743624274095c8a2fd65`;
  ...
  return (
    <div className='container'>
            ...
            !city?(
                ...
                <h4 className='cur_temp'>Current Temperature : {city.temp} <sup>o</sup>C</h4>
                <p className='text'>min temp {city.temp_min}<sup>o</sup>C | max temp : {city.temp_max}<sup>o</sup>C</p>
